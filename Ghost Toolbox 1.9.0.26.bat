...
nhcolor 03 " [8] | Stops Windows Updates until 2050 | Apps Updates      [37] | 7-Zip 21.04 beta                                   "
...
nhcolor 0E " ----------------------                                     %Red%-----------------------------------------------------------"
nhcolor 04 " [16] | %Lightgray%Visual C++ Redistributables AIO 2021-11-08 (system) %Red%:    NOTE: Before Start Downloading Set Your Timezone     :"
...
cd "%systemdrive%\ghost toolbox\wget"
cls
wget -q --show-progress --load-cookies cookies.txt --save-cookies cookies.txt --keep-session-cookie -c --no-check-certificate "https://www.7-zip.org/a/7z2104-x64.exe" -t 5 -O "7z2104-x64.exe"
"7z2104-x64.exe" /S
cls
echo  installing....
timeout /t 2 >nul
...
cd "%systemdrive%\ghost toolbox\wget"
cls
wget -q --show-progress --load-cookies cookies.txt --save-cookies cookies.txt --keep-session-cookie -c --no-check-certificate "https://www.7-zip.org/a/7z2104.exe" -t 5 -O "7z2104.exe"
"7z2104.exe" /S
cls
echo  installing....
timeout /t 2 >nul
...
cls
:startdownload
wget -q --show-progress --load-cookies cookies.txt --save-cookies cookies.txt --keep-session-cookie -c --no-check-certificate "https://github.com/abbodi1406/vcredist/releases/download/v0.55.0/VisualCppRedist_AIO_x86_x64_55.zip" -t 15 -O "VisualCppRedist_AIO_x86_x64_55.zip"
cls
7z1900-extra\7za x VisualCppRedist_AIO_x86_x64_55.zip -aoa
...
nhcolor 08 " ----------------"
color 03
aria2c\aria2c --console-log-level=warn --no-conf --file-allocation=none --check-certificate=false --continue=true --allow-overwrite=true --auto-file-renaming=false --continue=true --allow-overwrite=true --auto-file-renaming=false --http-user="rsload.net" --http-passwd="rsload.net" "https://bit.ly/3pPV0BD" -o"IOBit.Driver.Booster.v9.0.1.104.repack.zip"
timeout /t 5 >nul
cls
7z1900-extra\7za x "IOBit.Driver.Booster.v9.0.1.104.repack.zip" -aoa -pdb -oIOBit.Driver.Booster.v9.0.1.104.repack"
cls
echo. The program is being installed... Wait for the operation to complete.
timeout /t 3 >nul
cd "IOBit.Driver.Booster.v9.0.1.104.repack"
FOR %%i IN ("IObit Driver Booster*.exe") DO Set FileName="%%i"
%FileName% /SILENT
cd..
rd /s /q "IOBit.Driver.Booster.v9.0.1.104.repack" >nul 2>nul
timeout /t 2 >nul
...
title GHOST TOOLBOX 1.9.0.26 %GARC% && goto imnotdoneyet
::cls
::cd "%systemdrive%\ghost toolbox\wget"
...
:forwin1121H2
echo wscript.quit MsgBox ("Found new update 22000.318, you want to download standalone now? ", 4, "Check for Updates") > yesno.vbs
wscript //nologo yesno.vbs
set value=%errorlevel%
del yesno.vbs
...
:for21H2
echo wscript.quit MsgBox ("Found new update 19044.1381, you want to download standalone now? ", 4, "Check for Updates") > yesno.vbs
wscript //nologo yesno.vbs
set value=%errorlevel%
del yesno.vbs
...
if "%value%"=="7" timeout /t 5 >nul && goto :GHOSTSPECTRE >nul
:for21H1
echo wscript.quit MsgBox ("Found new update 19043.1381, you want to download standalone now? ", 4, "Check for Updates") > yesno.vbs
wscript //nologo yesno.vbs
set value=%errorlevel%
del yesno.vbs
if "%value%"=="6" goto web21H1 >nul
if "%value%"=="7" timeout /t 5 >nul && goto :GHOSTSPECTRE >nul
:for2009
echo wscript.quit MsgBox ("Found new update 19042.1381, you want to download standalone now? ", 4, "Check for Updates") > yesno.vbs
wscript //nologo yesno.vbs
set value=%errorlevel%
del yesno.vbs
