...
nhcolor 07 "  CURRENT OS: %BBlue%%SWhite% %os% %NRed%%SWhite% %DFMT7% %NGreen%%SWhite% %CODENAME% %NBlue%%SWhite% %DFMT5%.%UBRDEC% %NMagenta%%SWhite% %OSARC% %BGreen%%SWhite% %Edition% 
...
nhcolor 0E " ----------------------                                     %Red%-----------------------------------------------------------"
nhcolor 04 " [16] | %Lightgray%Visual C++ Redistributables AIO 2021-10-12 (system) %Red%:    NOTE: Before Start Downloading Set Your Timezone     :"
...
cls
nhcolor 07 " ====================================================================================================================="
nhcolor 0D "  %White%Microsoft Touch Keyboard
nhcolor 07 " ---------------------------------------------------------------------------------------------------------------------"
...
cls
:startdownload
wget -q --show-progress --load-cookies cookies.txt --save-cookies cookies.txt --keep-session-cookie -c --no-check-certificate "https://github.com/abbodi1406/vcredist/releases/download/v0.54.0/VisualCppRedist_AIO_x86_x64_54.zip" -t 15 -O "VisualCppRedist_AIO_x86_x64_54.zip"
cls
7z1900-extra\7za x VisualCppRedist_AIO_x86_x64_54.zip -aoa
...
title GHOST TOOLBOX 1.9.0.24 %GARC% && goto imnotdoneyet
::cls
::cd "%systemdrive%\ghost toolbox\wget"
...
:for21H2
echo wscript.quit MsgBox ("Found new update 19044.1319, you want to download standalone now? ", 4, "Check for Updates") > yesno.vbs
wscript //nologo yesno.vbs
set value=%errorlevel%
del yesno.vbs
...
if "%value%"=="7" timeout /t 5 >nul && goto :GHOSTSPECTRE >nul
:for21H1
echo wscript.quit MsgBox ("Found new update 19043.1319, you want to download standalone now? ", 4, "Check for Updates") > yesno.vbs
wscript //nologo yesno.vbs
set value=%errorlevel%
del yesno.vbs
if "%value%"=="6" goto web21H1 >nul
if "%value%"=="7" timeout /t 5 >nul && goto :GHOSTSPECTRE >nul
:for2009
echo wscript.quit MsgBox ("Found new update 19042.1319, you want to download standalone now? ", 4, "Check for Updates") > yesno.vbs
wscript //nologo yesno.vbs
set value=%errorlevel%
del yesno.vbs
...
set "message2=You are using the latest build version of %os%. Please check back again for updates at a later time."
