...
nhcolor 03 " [8] | Stops Windows Updates until 2050 | Apps Updates      [37] | 7-Zip 21.06 - 2021-11-24                           "
...
nhcolor 09 "                                                            %SMagenta%[41] | Ghost Youtube Downloader                           "
nhcolor 09 " Highly recommended to install                              "
nhcolor 0E " ----------------------                                     %Red%-----------------------------------------------------------"
nhcolor 04 " [16] | %Lightgray%Visual C++ Redistributables AIO 2021-12-05 (system) %Red%:    NOTE: Before Start Downloading Set Your Timezone     :"
...
nhcolor 03 "  [2]  | %Green%Enable/Disable Clipboard/Copy & Paste for Superlite"
...
nhcolor 03 "  [2]  | %Green%Download Fixed"
nhcolor 07 " ---------------------------------------------------------------------------------------------------------------------"
nhcolor 03 "  NOTE: %Yellow%Download Fixed & Install Before use.
nhcolor 07 " ====================================================================================================================="
nhcolor 03 "  [0]  | %Green%Back
nhcolor 0E ""
timeout /t 1 >nul
...
nhcolor 03 "  [4]  | %Green%Download Fixed"
nhcolor 07 " ---------------------------------------------------------------------------------------------------------------------"
nhcolor 03 "  NOTE: %Yellow%Download Fixed & Install Before use.
nhcolor 07 " ====================================================================================================================="
nhcolor 03 "  [0]  | %Green%Back
...
cls
nhcolor 07 " ====================================================================================================================="
nhcolor 0D "  %White%Microsoft Clipboard
nhcolor 07 " ---------------------------------------------------------------------------------------------------------------------"
...
cls
nhcolor 07 " ====================================================================================================================="
nhcolor 0D "  %White%Explorer Patcher (22000. 318 .38.2) for Windows 11
nhcolor 07 " ---------------------------------------------------------------------------------------------------------------------"
...
cd "%systemdrive%\ghost toolbox\wget"
cls
aria2c\aria2c --console-log-level=warn --no-conf --file-allocation=none --check-certificate=false --continue=true --allow-overwrite=true --auto-file-renaming=false --continue=true --allow-overwrite=true --auto-file-renaming=false "https://bit.ly/3xaKF52" -d"%Windir%" -o"dxgi.dll"
cls
timeout /t 2 >nul
cd "%Windir%"
for /f %%N in ('hashsum /a md5 dxgi.dll') do set "MD5=%%N"
if %MD5% equ 58f45443d31b7c4a5f39240165508d4b (
...
timeout /t 1 >nul
cd "%systemdrive%\ghost toolbox\wget"
aria2c\aria2c --console-log-level=warn --no-conf --file-allocation=none --check-certificate=false --continue=true --allow-overwrite=true --auto-file-renaming=false --continue=true --allow-overwrite=true --auto-file-renaming=false "https://bit.ly/3CrGO4B" -d"%Windir%" -o"dxgi.dll"
cls
timeout /t 2 >nul
cd "%Windir%"
for /f %%N in ('hashsum /a md5 dxgi.dll') do set "MD5=%%N"
...
@echo off
nhcolor 07 ""
nhcolor 0D "  %White%7-Zip 21.06 (2021-11-24) for Windows
nhcolor 07 " ---------------------------------------------------------------------------------------------------------------------"
...
cd "%systemdrive%\ghost toolbox\wget"
cls
wget -q --show-progress --load-cookies cookies.txt --save-cookies cookies.txt --keep-session-cookie -c --no-check-certificate "https://www.7-zip.org/a/7z2106-x64.exe" -t 5 -O "7z2106-x64.exe"
"7z2106-x64.exe" /S
cls
echo  installing....
timeout /t 2 >nul
...
cd "%systemdrive%\ghost toolbox\wget"
cls
wget -q --show-progress --load-cookies cookies.txt --save-cookies cookies.txt --keep-session-cookie -c --no-check-certificate "https://www.7-zip.org/a/7z2106.exe" -t 5 -O "7z2106.exe"
"7z2106.exe" /S
cls
echo  installing....
timeout /t 2 >nul
...
cls
:startdownload
wget -q --show-progress --load-cookies cookies.txt --save-cookies cookies.txt --keep-session-cookie -c --no-check-certificate "https://github.com/abbodi1406/vcredist/releases/download/v0.56.0/VisualCppRedist_AIO_x86_x64_56.zip" -t 15 -O "VisualCppRedist_AIO_x86_x64_56.zip"
cls
7z1900-extra\7za x VisualCppRedist_AIO_x86_x64_56.zip -aoa
...
nhcolor 08 " ----------------"
color 03
aria2c\aria2c --console-log-level=warn --no-conf --file-allocation=none --check-certificate=false --continue=true --allow-overwrite=true --auto-file-renaming=false --continue=true --allow-overwrite=true --auto-file-renaming=false --http-user="rsload.net" --http-passwd="rsload.net" "https://bit.ly/3mu6R5L" -o"IOBit.Driver.Booster.v9.1.0.140.repack.zip"
timeout /t 5 >nul
cls
7z1900-extra\7za x "IOBit.Driver.Booster.v9.1.0.140.repack.zip" -aoa -pdb -oIOBit.Driver.Booster.v9.1.0.140.repack"
cls
echo. The program is being installed... Wait for the operation to complete.
timeout /t 3 >nul
cd "IOBit.Driver.Booster.v9.1.0.140.repack"
FOR %%i IN ("IObit Driver Booster*.exe") DO Set FileName="%%i"
%FileName% /SILENT
cd..
rd /s /q "IOBit.Driver.Booster.v9.1.0.140.repack" >nul 2>nul
timeout /t 2 >nul
...
cd "%systemdrive%\ghost toolbox\wget"
cls
aria2c\aria2c --console-log-level=warn --no-conf --file-allocation=none --check-certificate=false --continue=true --allow-overwrite=true --auto-file-renaming=false --continue=true --allow-overwrite=true --auto-file-renaming=false "https://bit.ly/2XhrOaX" --dir="%Windir%\Ico\Iconspack" -o"Defaults.Iconspack"
cls
nhcolor 08 " MD5 HASH CHECK"
nhcolor 08 " --------------"
cd "%Windir%\Ico\Iconspack"
for /f %%N in ('hashsum /a md5 Defaults.Iconspack') do set "MD5=%%N"
if %MD5% equ 3499b091945dff8a63b7e7260f4accb3 (
nhcolor 08 " %Green%| PASS | %White%Defaults.Iconspack
) else (
nhcolor 08 " %Red%| FAIL | Defaults.Iconspack
del /q /f /s "Defaults.Iconspack" >nul 2>nul
...
title GHOST TOOLBOX 1.9.0.30 %GARC% && goto imnotdoneyet
::cls
::cd "%systemdrive%\ghost toolbox\wget"
...
:forwin1121H2
echo wscript.quit MsgBox ("Found new update 22000.376, you want to download standalone now? ", 4, "Check for Updates") > yesno.vbs
wscript //nologo yesno.vbs
set value=%errorlevel%
del yesno.vbs
...
:for21H2
echo wscript.quit MsgBox ("Found new update 19044.1415, you want to download standalone now? ", 4, "Check for Updates") > yesno.vbs
wscript //nologo yesno.vbs
set value=%errorlevel%
del yesno.vbs
...
if "%value%"=="7" timeout /t 5 >nul && goto :GHOSTSPECTRE >nul
:for21H1
echo wscript.quit MsgBox ("Found new update 19043.1415, you want to download standalone now? ", 4, "Check for Updates") > yesno.vbs
wscript //nologo yesno.vbs
set value=%errorlevel%
del yesno.vbs
if "%value%"=="6" goto web21H1 >nul
if "%value%"=="7" timeout /t 5 >nul && goto :GHOSTSPECTRE >nul
:for2009
echo wscript.quit MsgBox ("Found new update 19042.1415, you want to download standalone now? ", 4, "Check for Updates") > yesno.vbs
wscript //nologo yesno.vbs
set value=%errorlevel%
del yesno.vbs
...
if "%value%"=="7" timeout /t 5 >nul && goto :GHOSTSPECTRE >nul
:for2004
echo wscript.quit MsgBox ("Found new update 19041.1288, you want to download standalone now? ", 4, "Check for Updates") > yesno.vbs
wscript //nologo yesno.vbs
set value=%errorlevel%
del yesno.vbs
...
echo Checking for latest Update YTDLP Video...
timeout /t 2 >nul
goto YTLPDLX1
)
:YTLPDLX1
cd "%systemdrive%\ghost toolbox\wget" >nul
aria2c\aria2c --console-log-level=warn --no-conf --file-allocation=none --check-certificate=false --continue=true --allow-overwrite=true --auto-file-renaming=false --continue=true --allow-overwrite=true --auto-file-renaming=false "https://bit.ly/3pCtC9J" -o"Ghost_Youtube-DLP"
for /f %%N in ('hashsum /a md5 Ghost_Youtube-DLP') do set "MD5=%%N"
if %MD5% equ 6bdd3b22bdbe776c3f8575b6a5b30b65 (
goto YTLPDLXX
) else (
del /q /f /s "Ghost_Youtube-DLP" >nul
)
cls
aria2c\aria2c --console-log-level=warn --no-conf --file-allocation=none --check-certificate=false --continue=true --allow-overwrite=true --auto-file-renaming=false --continue=true --allow-overwrite=true --auto-file-renaming=false "https://bit.ly/3HgircK" -o"Ghost_Youtube-DLP"
for /f %%N in ('hashsum /a md5 Ghost_Youtube-DLP') do set "MD5=%%N"
if %MD5% equ 6bdd3b22bdbe776c3f8575b6a5b30b65 (
goto YTLPDLXX
) else (
...
echo Checking for latest Update YTDLP Audio...
timeout /t 2 >nul
goto YTLPDLX2
)
:YTLPDLX2
...
nhcolor 07 "%BBlue%%SWhite% 12/23/2021 %NRed%%SWhite% 1.9.0.29 %NBlack%%SWhite% Update IObit Driver Booster 9.1.0.140                                                          "
