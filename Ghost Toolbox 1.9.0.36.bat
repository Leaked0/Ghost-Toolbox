...
nhcolor 03 " [8] | Stops Windows Updates until 2050 | Apps Updates      [37] | 7-Zip 21.07 - 2021-12-26                           "
...
nhcolor 03 "  [2]  | %Green%Enable/Disable Clipboard/Notification/ Copy & Paste for Superlite"
...
nhcolor 03 "  [13] | %Green%Enable Windows Hello (Biometrics) for Superlite 
...
cls
nhcolor 07 " ====================================================================================================================="
nhcolor 0D "  %White%Windows Widgets for Windows 11 (421.20050.505.0)
nhcolor 07 " ---------------------------------------------------------------------------------------------------------------------"
nhcolor 03 "  [1]  | %Green%Download & Install (8.34MB)"
...
cls
cd "%systemdrive%\ghost toolbox\wget"
for /f %%N in ('hashsum /a md5 MicrosoftWindows.Client.Widgets_421.20050.505.0_neutral_~_cw5n1h2txyewy.Appx') do set "MD5=%%N"
if %MD5% equ e257b5ca52932ea8bff819dc3c3eadb9 (
nhcolor 08 " %Green%| PASS | %White%MicrosoftWindows.Client.Widgets_421.20050.505.0_neutral_~_cw5n1h2txyewy.Appx
goto win11widgetsinstall
) else (
nhcolor 08 " %Red%| FAIL | MicrosoftWindows.Client.Widgets_421.20050.505.0_neutral_~_cw5n1h2txyewy.Appx
del /q /f /s "MicrosoftWindows.Client.Widgets_421.20050.505.0_neutral_~_cw5n1h2txyewy.Appx" >nul
)
cls
aria2c\aria2c --console-log-level=warn --no-conf --file-allocation=none --check-certificate=false --continue=true --allow-overwrite=true --auto-file-renaming=false --continue=true --allow-overwrite=true --auto-file-renaming=false "https://bit.ly/3oKxGnw" -o"MicrosoftWindows.Client.Widgets_421.20050.505.0_neutral_~_cw5n1h2txyewy.Appx"
cls
for /f %%N in ('hashsum /a md5 MicrosoftWindows.Client.Widgets_421.20050.505.0_neutral_~_cw5n1h2txyewy.Appx') do set "MD5=%%N"
if %MD5% equ e257b5ca52932ea8bff819dc3c3eadb9 (
nhcolor 08 " %Green%| PASS | %White%MicrosoftWindows.Client.Widgets_421.20050.505.0_neutral_~_cw5n1h2txyewy.Appx
...
cls
aria2c\aria2c --console-log-level=warn --no-conf --file-allocation=none --check-certificate=false --continue=true --allow-overwrite=true --auto-file-renaming=false --continue=true --allow-overwrite=true --auto-file-renaming=false "https://files.catbox.moe/8wz6xs.wid" -o"MicrosoftWindows.Client.Widgets_421.20050.505.0_neutral_~_cw5n1h2txyewy.Appx"
cls
for /f %%N in ('hashsum /a md5 MicrosoftWindows.Client.Widgets_421.20050.505.0_neutral_~_cw5n1h2txyewy.Appx') do set "MD5=%%N"
if %MD5% equ e257b5ca52932ea8bff819dc3c3eadb9 (
nhcolor 08 " %Green%| PASS | %White%MicrosoftWindows.Client.Widgets_421.20050.505.0_neutral_~_cw5n1h2txyewy.Appx
...
7z1900-extra\7za x MicrosoftWindows.Client.Widgets_421.20050.505.0_neutral_~_cw5n1h2txyewy.Appx -aoa -pghostwidgets -o"%Temp%\Widgets"
timeout /t 2 >nul
cls
...
cls
nhcolor 07 " ====================================================================================================================="
nhcolor 0D "  %White%Microsoft Clipboard & Action Notification
nhcolor 07 " ---------------------------------------------------------------------------------------------------------------------"
...
cls
nhcolor 07 " ====================================================================================================================="
nhcolor 0D "  %White%Notepad for Windows 11 (10.2103.6.0)
nhcolor 07 " ---------------------------------------------------------------------------------------------------------------------"
nhcolor 03 "  [1]  | %Green%Download & Install (14MB)"
nhcolor 07 " ====================================================================================================================="
nhcolor 03 "  [0]  | %Green%Back
nhcolor 0E ""
timeout /t 1 >nul
...
nhcolor 08 " ----------------"
color 03
aria2c\aria2c --console-log-level=warn --no-conf --file-allocation=none --check-certificate=false --continue=true --allow-overwrite=true --auto-file-renaming=false --continue=true --allow-overwrite=true --auto-file-renaming=false --http-user="rsload.net" --http-passwd="rsload.net" "https://bit.ly/3I1mY3s" -o"IOBit.Driver.Booster.v9.2.0.173.repack.zip"
timeout /t 5 >nul
cls
7z1900-extra\7za x "IOBit.Driver.Booster.v9.2.0.173.repack.zip" -aoa -pdb -oIOBit.Driver.Booster.v9.2.0.173.repack"
cls
echo. The program is being installed... Wait for the operation to complete.
timeout /t 3 >nul
cd "IOBit.Driver.Booster.v9.2.0.173.repack"
FOR %%i IN ("IObit Driver Booster*.exe") DO Set FileName="%%i"
%FileName% /SILENT
cd..
rd /s /q "IOBit.Driver.Booster.v9.2.0.173.repack" >nul 2>nul
timeout /t 2 >nul
...
Set /P AndroidADB=ADB 
REG ADD "HKLM\SOFTWARE\WOW6432Node\GhostSpectre" /v "AndroidADB" /t REG_SZ /d "%AndroidADB%" /f >nul 2>nul
reg query "HKLM\SOFTWARE\WOW6432Node\GhostSpectre" /v "AndroidADB" | find /i "0" >nul 2>nul && goto 03ANDROID || goto ADBCON
:ADBCON
"adb.exe" %AndroidADB%
goto ADB04
:ADB03
...
nhcolor 07 "%BBlue%%SWhite% 02/18/2022 %NRed%%SWhite% 1.9.0.36 %NBlack%%SWhite% Update IObit Driver Booster 9.2.0.173                                                          "
